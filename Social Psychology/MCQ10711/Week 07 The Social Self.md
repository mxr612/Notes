# Week 07 The Social Self - Practice MCQs
...
B. Only traits others assign to you

C. A fixed biological essence unaffected by context
...
B. We imagined ourselves as children only

C. We think others see us, not necessarily how they actually do
...
B. Group memberships as well as personal traits

C. Biological ancestry alone
...
B. Random labels assigned by peers

C. A public reputation score
...
B. Remove all social comparison needs

C. Restore threatened self-esteem by favouring in-groups
...
B. Genetic markers of personality

C. Beliefs and ideas people hold about themselves
...
B. The context-dependent subset of self-schemas currently salient

C. A hypothetical self with no real influence
...
B. Consulting authoritative books
...
B. External rewards are withheld for disliked tasks

C. Intrinsic motivation is unrelated to rewards
...
B. Internal satisfaction or interest

C. Avoidance of punishment only
...
B. Social comparison is unrelated to self-evaluation

C. Many attributes lack objective standards, so others provide a benchmark
...
B. Decrease self-esteem but also motivate improvement

C. Always raise self-esteem
...
B. Always demotivate performance

C. Remove all anxiety permanently
...
B. Overall aggregated self-opinion at a given time

C. A trait limited to childhood
...
B. A perception of belonging across all contexts

C. The tendency to compare upward
...
B. A measure that varies every hour

C. The immediate reaction to social rejection today
...
B. Avoid any self-reflection

C. Always believe others are better
...
B. Take blame for failures and credit others for success

C. Attribute all outcomes to luck
...
B. A self-enhancing processing bias
...
B. Using strategies to be viewed positively by others

C. Abandoning self-monitoring
...
B. Avoiding any awareness of social cues

C. Always expressing genuine feelings regardless of context
...
B. Avoid modesty to signal confidence

C. Agree with others' opinions but not appear desperate for approval
...
B. Can be associated with dangerous traits like narcissism

C. Eliminates the need for self-knowledge
...
B. Relying on a single identity only

C. Refusing any feedback
...
B. Genetic testing only

C. External labels with no self-reflection

D. Self-schemas, discrepancies, behaviour observation, and social comparison
