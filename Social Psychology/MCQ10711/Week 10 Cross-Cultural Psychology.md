# Week 10 Cross-Cultural Psychology - Practice MCQs
...
B. A temporary mood that spreads through a population

C. Purely economic resources of a society
...
B. Equal representation of all cultures

C. Over-representation of WEIRD participants
...
B. Only genetics shape behaviour

C. Culture cannot influence cognition
...
B. Flexible boundaries and responsiveness to context

C. Defined mainly by relationships and obligations
...
B. Clear boundaries between self and others

C. Obligations to the group and fluid boundaries
...
B. Is universal across all cultures

C. Is absent in WEIRD samples only
...
B. Holistic, relationship-focused thinking

C. Purely random judgments
...
B. Random guessing in tasks

C. Spiritual explanations only
...
B. Collectivist, such as Japan and Fiji

C. Industrialized North American only
...
B. Collectivist and egalitarian

C. Individualistic and egalitarian
...
B. Enhances stereotypes and prejudices if superficial

C. Removes intergroup anxiety
...
B. Partial universality with cultural display rules shaping expression

C. Complete invariance in expression and interpretation
...
B. That ignores cultural context to find universals

C. Limited to biological measures
...
B. Do not affect the self

C. Create unique patterns of privilege or oppression
...
B. Increase self-discrepancy and lower self-esteem

C. Have no impact on well-being
...
B. Only when groups were male-dominated

C. Only in female-dominated groups
...
B. More favourably than male leaders

C. Identically to male leaders
...
B. No effect of overlapping identities

C. Unique patterns in self-esteem and belonging
...
B. Analyse intersecting identities simultaneously

C. Focus solely on socioeconomic status
...
C. The importance of laboratory control
...
B. High home culture retention and low dominant culture adoption

C. High involvement in both cultures
...
B. Elimination of social obligations

C. Complete individual autonomy
...
B. Shaped by culture, cognition, values, and intersecting identities

C. Only determined by biology and genetics

D. Impossible to compare across cultures
