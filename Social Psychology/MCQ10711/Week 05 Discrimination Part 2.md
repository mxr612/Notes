# Week 05 Discrimination Part 2 - Practice MCQs
...
B. Avoid any social desirability concerns

C. Cannot complete them online
...
B. Consciously acknowledged and openly expressed

C. Only measured by the IAT
...
B. Open hostility and explicit slurs

C. Legal policies mandating segregation
...
B. Unconscious bias revealed only by reaction time

C. A deliberate slur or action meant to hurt the target
...
B. Overt physical aggression

C. Explicit agreement with equality norms
...
B. Excludes or nullifies the reality of a minority person's experience

C. Provides positive feedback about performance
...
B. Dependent on formal instruction

C. Slow, effortful, and reflective
...
B. Slow, effortful, and conscious

C. Entirely emotion-driven
...
B. Conscious endorsement after reflection

C. System 1 automatic processing
...
B. Attitudes may be hidden or inaccessible to introspection

C. Behaviour always perfectly matches self-reports
...
B. People cannot understand any questions

C. Explicit reports never change over time
...
B. Guessing randomly under time pressure

C. Sorting pairings consistent with their associations
...
B. Brand preferences in consumer behaviour

C. Memory for neutral words
...
B. Always show zero bias on the IAT

C. Never understand how the IAT works
...
B. Faster decisions to shoot Black suspects

C. No difference in response speed
...
B. Having interviewers rate videos without CVs

C. Sending matched CVs that differ only on group cues and tracking call-backs
...
B. 17% more CVs than British-sounding names

C. 23% more CVs than British-sounding names
...
B. Bias only when names were paired with photos

C. No explicit bias, while IAT scores predicted hiring likelihood
...
B. A single positive cue boosts overall evaluation

C. No cues are available, so judgement is random
...
B. Disappear immediately after a single warning

C. Increase only in laboratory contexts
...
B. Treating biases as fixed and unchangeable

C. Ignoring contextual cues like names or backgrounds

D. Addressing both implicit and explicit processes and situational cues
