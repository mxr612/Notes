# Week 01 Introduction - Practice MCQs
...
B. The actual, imagined, or implied presence of others

C. Large-scale economic forces over long periods
...
B. Describing macro-level demographic trends without testing mechanisms

C. Archival analysis of institutions without considering individuals
...
B. Prioritising philosophical debate over data

C. Using research to generate interventions that solve social problems
...
B. Focus solely on within-person biology to explain conflict

C. Avoid drawing on evidence when proposing solutions
...
B. You can memorise every researcher name linked to a topic

C. You recall definitions verbatim without being able to use them
...
B. Applying persuasion and crowd psychology in propaganda campaigns

C. Training medics in operant conditioning techniques
...
B. Avoiding any attempt to shift consumer attitudes

C. Basing campaigns solely on celebrity endorsements without theory
...
B. No measurable differences from babies of non-smokers

C. Withdrawal-like symptoms and a higher likelihood of SIDS
...
B. Equal numbers of fouls by both teams

C. More fouls committed by Princeton than by Dartmouth
...
B. Measurement error caused solely by poor video quality

C. Construed reality shaped by group allegiance
...
B. Change beliefs whenever a single contrary fact appears

C. Ignore all prior beliefs while evaluating information
...
B. Designing a study to falsify your current hypothesis

C. Ignoring any evidence until a peer replicates it
...
B. Heart-rate monitors detecting teacher stress

C. Eye-tracking technology that recorded gaze location
...
B. Teachers spent more time monitoring Black children, especially Black boys, despite no misbehaviour

C. Teachers distributed visual attention equally across all four children
...
B. They proved misbehaviour is entirely genetic

C. They demonstrated that preschoolers cannot be objectively observed
...
B. Influence of the actual physical presence of others

C. Influence of the implied presence of others
...
B. A reciprocity norm asking for a small favour

C. A descriptive norm showing everyone else smokes
...
B. It tests explanations of social influence through systematic empirical methods

C. It prefers anecdotes over observable data
...
B. Only work when audiences are coerced

C. Became obsolete after World War II
...
B. Objective appraisal of all available facts

C. Random fluctuation unrelated to belief
...
B. Purely descriptive observation

C. Construing social reality through expectancy-driven monitoring
...
B. The interplay between individual minds and social contexts

C. Geological forces shaping human habitats
...
B. Prioritise rote recall for short-term tests

C. Keep knowledge abstract and detached from life
...
B. Reinforcement schedules to shape operant behaviour

C. Punishment to extinguish a conditioned response
...
B. Anchoring and adjustment only

C. Expectancy-driven selective attention
...
B. Emotional appeals and vivid imagery to shift attitudes

C. Total avoidance of slogans or symbols
...
B. Ignoring ethical considerations in pursuit of results

C. Avoiding engagement with social policy
...
B. Motivated reasoning tied to identity

C. Random sampling error only
...
B. They are unrelated to behaviour outside the lab

C. They are rare enough to ignore

D. They only matter when studying animals rather than people
